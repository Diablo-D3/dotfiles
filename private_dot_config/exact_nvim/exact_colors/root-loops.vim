...
" Webpage:          https://rootloops.sh?sugar=7&colors=6&sogginess=0&flavor=1&fruit=10&milk=0.77
...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi NonText ctermfg=0 guifg=#101010
    hi Comment ctermfg=7 cterm=italic guifg=#a8a8a8 gui=italic
    ...
    hi Delimiter ctermfg=15 guifg=#e9e9e9
    ...
    hi Todo ctermbg=12 ctermfg=0 cterm=bold guibg=#88b1e5 guifg=#101010 gui=bold
    hi Type ctermfg=11 guifg=#d3a563
    hi Underlined cterm=underline gui=underline
    hi Bold cterm=bold gui=bold
    hi Italic cterm=italic gui=italic
    hi Ignore ctermbg=NONE ctermfg=NONE cterm=NONE guibg=NONE guifg=NONE gui=NONE
    hi StatusLine ctermbg=0 ctermfg=15 cterm=NONE guibg=#292929 guifg=#e9e9e9 gui=NONE
    hi StatusLineNC ctermbg=0 ctermfg=15 cterm=NONE guibg=#101010 guifg=#dadada gui=NONE
    hi VertSplit ctermfg=8 guifg=#555555
    hi TabLine ctermbg=0 ctermfg=7 guibg=#292929 guifg=#a8a8a8
    hi TabLineFill ctermbg=NONE ctermfg=0 guibg=NONE guifg=#292929
    hi TabLineSel ctermbg=11 ctermfg=0 guibg=#d3a563 guifg=#292929
    hi Title ctermfg=4 cterm=bold guifg=#6b9bd9 gui=bold
    hi CursorLine ctermbg=0 ctermfg=NONE guibg=#292929 guifg=NONE
    hi Cursor ctermbg=15 ctermfg=0 guibg=#e9e9e9 guifg=#101010
    hi CursorColumn ctermbg=0 guibg=#292929
    ...
    hi Visual ctermbg=8 ctermfg=15 cterm=bold guibg=#555555 guifg=#e9e9e9 gui=bold
    hi VisualNOS ctermbg=8 ctermfg=15 cterm=bold guibg=#555555 guifg=#e9e9e9 gui=bold
    hi Pmenu ctermbg=0 ctermfg=15 guibg=#292929 guifg=#e9e9e9
    hi PmenuSbar ctermbg=8 ctermfg=7 guibg=#555555 guifg=#a8a8a8
    hi PmenuSel ctermbg=8 ctermfg=15 cterm=bold guibg=#555555 guifg=#e9e9e9 gui=bold
    hi PmenuThumb ctermbg=7 ctermfg=NONE guibg=#a8a8a8 guifg=NONE
    hi FoldColumn ctermfg=7 guifg=#a8a8a8
    hi Folded ctermfg=12 guifg=#88b1e5
    hi WildMenu ctermbg=0 ctermfg=15 cterm=NONE guibg=#292929 guifg=#e9e9e9 gui=NONE
    hi SpecialKey ctermfg=0 guifg=#292929
    hi IncSearch ctermbg=1 ctermfg=0 guibg=#d97780 guifg=#101010
    hi CurSearch ctermbg=3 ctermfg=0 guibg=#bc904f guifg=#101010
    hi Search ctermbg=11 ctermfg=0 guibg=#d3a563 guifg=#101010
    hi Directory ctermfg=4 guifg=#6b9bd9
    hi MatchParen ctermbg=0 ctermfg=3 cterm=bold guibg=#292929 guifg=#bc904f gui=bold
    ...
    hi ColorColumn ctermbg=8 guibg=#555555
    hi SignColumn ctermfg=7 guifg=#a8a8a8
    hi ModeMsg ctermbg=15 ctermfg=0 cterm=bold guibg=#dadada guifg=#292929 gui=bold
    hi MoreMsg ctermfg=4 guifg=#6b9bd9
    hi Question ctermfg=4 guifg=#6b9bd9
    hi QuickFixLine ctermbg=0 ctermfg=14 guibg=#292929 guifg=#63c0bf
    hi Conceal ctermfg=8 guifg=#555555
    hi ToolbarLine ctermbg=0 ctermfg=15 guibg=#292929 guifg=#dadada
    hi ToolbarButton ctermbg=8 ctermfg=15 guibg=#555555 guifg=#dadada
    hi debugPC ctermfg=7 guifg=#a8a8a8
    hi debugBreakpoint ctermfg=8 guifg=#555555
    hi ErrorMsg ctermfg=1 cterm=bold,italic guifg=#d97780 gui=bold,italic
    hi WarningMsg ctermfg=11 guifg=#d3a563
    hi DiffAdd ctermbg=10 ctermfg=0 guibg=#8ebf73 guifg=#101010
    hi DiffChange ctermbg=12 ctermfg=0 guibg=#88b1e5 guifg=#101010
    hi DiffDelete ctermbg=9 ctermfg=0 guibg=#e6949a guifg=#101010
    hi DiffText ctermbg=14 ctermfg=0 guibg=#63c0bf guifg=#101010
    ...
    hi diffLine ctermfg=7 guifg=#a8a8a8
    ...
    hi NormalFloat ctermbg=0 ctermfg=15 guibg=#101010 guifg=#e9e9e9
    hi FloatBorder ctermbg=0 ctermfg=7 guibg=#101010 guifg=#a8a8a8
    hi FloatShadow ctermbg=0 ctermfg=15 guibg=#292929 guifg=#e9e9e9
    hi LspInlayHint ctermfg=8 guifg=#555555
    hi LspCodeLens ctermfg=8 guifg=#555555
    hi LspCodeLensSeparator ctermfg=8 guifg=#555555
    hi @variable ctermfg=15 guifg=#e9e9e9
    ...
    hi @punctuation.bracket ctermfg=15 guifg=#e9e9e9
    hi @comment.error ctermbg=9 ctermfg=0 guibg=#e6949a guifg=#101010
    hi @comment.warning ctermbg=11 ctermfg=0 guibg=#d3a563 guifg=#101010
    hi @comment.todo ctermbg=12 ctermfg=0 guibg=#88b1e5 guifg=#101010
    hi @comment.note ctermbg=14 ctermfg=0 guibg=#63c0bf guifg=#101010
    hi @markup ctermfg=15 guifg=#e9e9e9
    hi @markup.strong ctermfg=15 cterm=bold guifg=#e9e9e9 gui=bold
    hi @markup.italic ctermfg=15 cterm=italic guifg=#e9e9e9 gui=italic
    hi @markup.strikethrough ctermfg=15 cterm=strikethrough guifg=#e9e9e9 gui=strikethrough
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = [ '#292929', '#d97780', '#7aa860', '#bc904f', '#6b9bd9', '#b77ed1', '#52a9a9', '#a8a8a8', '#555555', '#e6949a', '#8ebf73', '#d3a563', '#88b1e5', '#c899de', '#63c0bf', '#dadada' ]
endif
